    ...
    <div className="space-y-4">
      ...
      {showReviewQueue ? (
        ...
        <>
          ...
          {showForm && (
            <div ref={formRef} className="animate-slide-down max-w-3xl">
              ...
              <div className="space-y-1 flex-1 min-w-[200px]">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-9 rounded-lg border border-slate-200 pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
                  />
                </div>
              </div>
