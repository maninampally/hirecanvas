      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-slate-700">
          <section>
            ...
            <p>
              By using HireCanvas, you agree to be bound by these Terms. If you do not agree, please stop using the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Permission is granted to temporarily access the materials (information or software) on HireCanvas for personal,
          ...
          <section>
            ...
            <p>
              In no event shall HireCanvas or its suppliers be liable for any damages (including, without limitation, damages for loss
              of data or profit, or due to business interruption) arising out of the use or inability to use the materials on HireCanvas.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The materials appearing on HireCanvas could include technical, typographical, or photographic errors. HireCanvas does not
              warrant that any of the materials on the Service are accurate, complete, or current.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              HireCanvas may revise these terms of service for our website at any time without notice. By using this website, you are agreeing
          ...
          <section>
            ...
            <p>
              These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which HireCanvas operates,
